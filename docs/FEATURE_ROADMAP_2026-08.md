...
| Ferramenta                                   | O que faz bem                                                                                                                                                                                | Onde o Prospeca pode ganhar                                                                                                                                                                           |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **GoHighLevel** (EUA, dominante em agências) | All-in-one: CRM + automação + IA conversacional/voz + gestão de reputação + white-label revendável pros clientes da agência. $97–497/mês.                                                    | GHL é genérico (qualquer nicho). Prospeca pode ser **fundo-a-fundo especializado em "negócio local sem presença digital"** — score e discovery que o GHL não tem nativo.                              |
| **RD Station CRM** (BR, líder)               | Funil visual, histórico de interação (inclui WhatsApp), automação de tarefas, free tier generoso, app mobile.                                                                                | RD Station não descobre lead — você importa o que já tem. Prospeca **gera o lead** a partir do mapa. Diferencial já existe, falta reforçar cadência/follow-up que o RD Station tem e o Prospeca não.  |
...
| **Agendor** (BR)                             | CRM simples + **geolocalização pra otimizar rota de visita comercial**.                                                                                                                      | Confirma que rota de visita é feature real e usada no mercado BR — e o Prospeca já tem mapa com os leads geolocalizados. Extensão natural, ninguém no nicho "sem site" faz isso ainda.                |
| **Econodata** (BR)                           | Base de 22M empresas, enriquecimento (faturamento presumido, sócios, redes sociais), gerador de leads grátis.                                                                                | Dado cadastral genérico, sem score de oportunidade nem pipeline. Prospeca já entrega isso pronto — Econodata é mais concorrente de dado bruto que de produto.                                         |
| **LeadForge** (BR, `leadforge.com.br`)       | CRM focado em WhatsApp: Kanban, resposta automática, follow-up programado, notificação de inatividade, qualificação automática, dashboard de tempo de resposta.                              | **Concorrente mais direto encontrado** — mesma tese de "vender pra negócio local via WhatsApp". Tem cadência automática que o Prospeca não tem. Prioridade alta fechar esse gap.                      |
| Padrão de mercado (pesquisa geral)           | Cadência eficaz combina WhatsApp + ligação em 4 toques ao longo de 14 dias, disparada por mudança de estágio no funil ("aguardando retorno" → dispara sequência).                            | Prospeca hoje é _"prepara 1 mensagem"_ — não _"cadência"_. É o gap mais citado em toda a pesquisa.                                                                                                    |
...
_Por quê:_ Agendor prova que o mercado BR usa e valoriza isso. Ninguém no nicho "empresa sem site" tem. Serve direto quem prospecta porta-a-porta, que é a realidade de muita agência pequena no Brasil.
...
_Por quê:_ É o gap nº1 apontado tanto pela pesquisa de mercado quanto pelo concorrente direto (LeadForge). Essa versão "manual assistida" é rápida de construir (reusa `NbaCard`/atividades que já existem) e prepara terreno pra automação de verdade depois (3.3).
...
_Por quê:_ Vira gatilho de venda concreto ("vi que sua nota caiu, posso ajudar") em vez de abordagem genérica.
...
_Por quê:_ Amplia o público endereçável (empresas com site ruim também são oportunidade, não só sem site) e dá ao vendedor um motivo específico e verificável pra abordar.
...
_Por quê:_ É o tipo de coisa que separa "ferramenta de lista" de "ferramenta que ajuda a vender". Mensagem específica converte mais que mensagem de template, e o dado pra isso já existe no lead — só falta a chamada de IA.
...
_Por quê:_ É o que separa Prospeca de virar "LeadForge 2.0". Investimento maior — só depois de validar que 3.2 (cadência manual) já está sendo usada e gerando resultado.
...
_Por quê:_ Relevante assim que uma agência cliente tiver mais de 1 vendedor — praticamente todo concorrente pesquisado (GHL, RD Station, Agendor) tem isso como recurso de plano pago.
...
Se o modelo de negócio de alguns clientes for "prospecção como serviço pro cliente deles", um relatório/PDF com a marca da agência (não a do Prospeca) mostrando atividade e resultados entregues. Bem mais barato que o "SaaS mode" completo do GHL — só um export com branding.
...
Joga o Prospeca no ecossistema de quem já usa outro CRM — modelo "alimentamos seu funil" em vez de competir de frente. Baixa prioridade pros primeiros 5 clientes, relevante pra escalar depois.
