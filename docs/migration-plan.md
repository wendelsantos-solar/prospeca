...
> Regra-mestra: **incremental, aditivo, não-destrutivo**. Cada fase termina com `bun run build` verde e sem _novos_ erros de lint/typecheck além dos pré-existentes (`setRadius`, prettier — ver `current-architecture.md`).
