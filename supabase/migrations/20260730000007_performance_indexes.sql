...
create index concurrently if not exists idx_search_results_search_score
...
create index concurrently if not exists idx_places_discovery
...
create index concurrently if not exists idx_searches_active
