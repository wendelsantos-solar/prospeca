// Normalization — consolidated from src/lib/phone.ts and
// supabase/functions/_shared/normalize.ts (previously duplicated).
// Pure functions; safe to import from web, edge functions and worker.
...
/** wa.me link — digits only, DDI included. null when invalid. */
...
const SOCIAL_DOMAINS = ["facebook.com", "instagram.com", "wa.me", "api.whatsapp.com", "linktr.ee"];
