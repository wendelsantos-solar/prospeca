...
export const SEED_TAXONOMY: BusinessTaxonomyEntry[] = [
  ...
  },
  {
    ...
    aliases: ["advocacia", "advogado", "advogada", "escritório de advocacia", "escritorio de advocacia"],
    placesTypes: ["lawyer"],
    cnaeCodes: ["6911-7/01"],
  ...
  },
  {
    ...
    name: "Contabilidade",
    slug: "contabilidade",
    aliases: ["contabilidade", "contador", "escritório de contabilidade", "escritorio de contabilidade"],
