    ...
    <div className="flex min-h-dvh bg-background">
      <div className="flex w-full flex-col justify-center px-4 py-8 md:w-[42%] md:min-w-[440px] md:max-w-[500px] md:px-10 lg:px-14">
        <div className="mb-8 flex items-center gap-2.5">
          <Link
            to="/"
            className="flex items-center gap-2.5 rounded-lg p-1 -ml-1 hover:bg-surface-hover transition-colors"
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div
            className={cn(
              "rounded-[16px] border border-border bg-surface p-6 shadow-elegant sm:p-8",
              className,
            )}
          >
            <div className="mb-6">
              <h1 className="text-page-title font-semibold text-foreground tracking-tight">
                {title}
              </h1>
