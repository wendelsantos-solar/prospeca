    ...
    <MarketingSection muted spacing="lg">
      <MarketingContainer width="wide">
        <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_1fr]">
          {/* Mockup — left (alternating from OpportunitySection which is text-left) */}
          <div className="order-2 lg:order-1">
            <BrowserFrame url="Mapa · Barbearia">
              <div className="relative h-72 bg-[oklch(0.955_0.012_156)] md:h-80">
